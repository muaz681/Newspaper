...
<div>
  ...
  <div class="bg-slate-50 py-2">
        <img src="https://tpc.googlesyndication.com/simgad/16812017396760261482" class="w-auto h-auto m-auto" alt="..." />
  </div>
  <div class="container mx-auto px-12 bg-slate-50">
    <div class="grid grid-cols-3 grid-flow-row gap-2 items-center">
        <div class="py-2">
			<button class="p-1 mr-4" @click.prevent="toggle()">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
        </svg>
      </button>
	  
          <img src="https://bn.voicetv.tv/assets/images/logo.png" class="max-w-xs h-auto m-auto" alt="..." />
        </div> 
        <!-- <div class="py-2"> -->
          <div class="flex justify-center py-2">
            <div class="xl:w-96">
              <div class="input-group relative flex items-stretch w-full">
                <input type="search" class="form-control relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-rose-600 focus:outline-none" placeholder="Search" aria-label="Search" aria-describedby="button-addon2">
                <button class="btn inline-block px-6 py-2.5 bg-red-700 text-white font-medium text-xs leading-tight uppercase shadow-md hover:bg-red-600 hover:shadow-lg focus:bg-red-600  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-600 active:shadow-lg transition duration-150 ease-in-out flex items-center" type="button" id="button-addon2">
  ...
  <div class="container mx-auto pr-16 pl-12 bg-red-700">
	  <div class="gird grid-flow-row gap-2 items-center overflow-x-hidden">
		  <nav class="flex space-x-4">
	<a href="/dashboard" class="font-medium px-3 py-2 text-white rounded-lg hover:bg-red-700 hover:text-white">Home</a>
	<a href="/team" class="font-medium px-3 py-2 text-white rounded-lg hover:bg-red-700 hover:text-white">Team</a>
	<a href="/projects" class="font-medium px-3 py-2 text-white rounded-lg hover:bg-red-700 hover:text-white">Projects</a>
	<a href="/reports" class="font-medium px-3 py-2 text-white rounded-lg hover:bg-red-700 hover:text-white">Reports</a>
	<a href="/dashboard" class="font-medium px-3 py-2 text-white rounded-lg hover:bg-red-700 hover:text-white">Home</a>
	<a href="/team" class="font-medium px-3 py-2 text-white rounded-lg hover:bg-red-700 hover:text-white">Team</a>
	<a href="/projects" class="font-medium px-3 py-2 text-white rounded-lg hover:bg-red-700 hover:text-white">Projects</a>
	<a href="/reports" class="font-medium px-3 py-2 text-white rounded-lg hover:bg-red-700 hover:text-white">Reports</a>
